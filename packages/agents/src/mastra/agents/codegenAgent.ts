...
/**
 * Codegen agent: builds full-stack Vite + React + Neon + Drizzle + shadcn solutions.
 * Tools are expected to be provided dynamically via toolsets; we keep none statically.
 */
export const codegenAgent = new Agent({
  name: 'codegenAgent',
  description:
    'Full-stack builder specializing in Vite, React, shadcn/ui, Drizzle + Neon, and Mastra orchestration.',
...
- Hono or lightweight Node APIs for backend services.
...
- Prefer simple module boundaries and framework-agnostic code.
