...
import { buildRuntimeContext, CodegenRuntimeContext } from './mastra/context';
import { composeToolsets, Toolset } from './mastra/tools';
 ...
 */
export async function runCodegenJob(
  input: CodegenJobInput,
): Promise<CodegenJobResult> {
  ...
  // Prefer stream to capture incremental output
